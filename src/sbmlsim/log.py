...
`sbmlsim` follows the convention for libraries: it only gets loggers and logs
...
All loggers are therefore below the `sbmlsim` logger, so an application
...
from sbmlsim.console import console as default_console

#: name of the logger all loggers of the package are below
PACKAGE_LOGGER = "sbmlsim"
