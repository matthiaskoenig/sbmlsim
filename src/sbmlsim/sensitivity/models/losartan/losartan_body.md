...
ald = <libsbml.ASTNode; proxy of <Swig Object of type 'ASTNode *' at 0x7931229ac690> >  # [mmol/l] aldosterone in Vplasma  
ang1 = <libsbml.ASTNode; proxy of <Swig Object of type 'ASTNode *' at 0x7931229ac4e0> >  # [mmol/l] angiotensin I in Vplasma  
ang2 = <libsbml.ASTNode; proxy of <Swig Object of type 'ASTNode *' at 0x7931229a6f10> >  # [mmol/l] angiotensin II in Vplasma  
anggen = <libsbml.ASTNode; proxy of <Swig Object of type 'ASTNode *' at 0x7931229a74b0> >  # [mmol/l] angiotensinogen in Vplasma  
cum_dose_e3174 = 0.0  # [mg] Cumulative dose due to infusion e3174  
cum_dose_los = 0.0  # [mg] Cumulative dose due to infusion los  
ren = <libsbml.ASTNode; proxy of <Swig Object of type 'ASTNode *' at 0x7931230e7750> >  # [mmol/l] renin in Vplasma  
```
...
# odes
d Afeces_e3174/dt = 0  # [mmol/min] E3174 (feces)  
d Afeces_l158/dt = 0  # [mmol/min] L158 (feces)  
d Afeces_los/dt = 0  # [mmol/min] losartan (feces)  
d Aurine_e3174/dt = 0  # [mmol/min] E3174 (urine)  
d Aurine_l158/dt = 0  # [mmol/min] L158 (urine)  
d Aurine_los/dt = 0  # [mmol/min] losartan (urine)  
...
d Cgu_e3174/dt = 0  # [mmol/l/min] E3174 (gut)  
d Cgu_l158/dt = 0  # [mmol/l/min] L158 (gut)  
d Cgu_los/dt = 0  # [mmol/l/min] losartan (gut)  
...
d Cgu_plasma_los/dt = Flow_ar_gu_los / Vgu_plasma - Flow_gu_po_los / Vgu_plasma  # [mmol/l/min] losartan (gut plasma)  
...
d Cki_plasma_e3174/dt = Flow_ar_ki_e3174 / Vki_plasma - Flow_ki_ve_e3174 / Vki_plasma  # [mmol/l/min] E3174 (kidney plasma)  
d Cki_plasma_l158/dt = Flow_ar_ki_l158 / Vki_plasma - Flow_ki_ve_l158 / Vki_plasma  # [mmol/l/min] L158 (kidney plasma)  
d Cki_plasma_los/dt = Flow_ar_ki_los / Vki_plasma - Flow_ki_ve_los / Vki_plasma  # [mmol/l/min] losartan (kidney plasma)  
d Cli_plasma_e3174/dt = Flow_arli_li_e3174 / Vli_plasma + Flow_po_li_e3174 / Vli_plasma - Flow_li_hv_e3174 / Vli_plasma  # [mmol/l/min] E3174 (liver plasma)  
d Cli_plasma_l158/dt = Flow_arli_li_l158 / Vli_plasma + Flow_po_li_l158 / Vli_plasma - Flow_li_hv_l158 / Vli_plasma  # [mmol/l/min] L158 (liver plasma)  
d Cli_plasma_los/dt = Flow_arli_li_los / Vli_plasma + Flow_po_li_los / Vli_plasma - Flow_li_hv_los / Vli_plasma  # [mmol/l/min] losartan (liver plasma)  
