...
extern void Jy_icg_sd(realtype *Jy, const int iy, const realtype *p, const realtype *k, const realtype *y, const realtype *sigmay, const realtype *my);
extern void dJydsigma_icg_sd(realtype *dJydsigma, const int iy, const realtype *p, const realtype *k, const realtype *y, const realtype *sigmay, const realtype *my);
extern void dJydy_icg_sd(realtype *dJydy, const int iy, const realtype *p, const realtype *k, const realtype *y, const realtype *sigmay, const realtype *my);
extern void dJydy_colptrs_icg_sd(SUNMatrixWrapper &colptrs, int index);
extern void dJydy_rowvals_icg_sd(SUNMatrixWrapper &rowvals, int index);
...
extern void dwdp_icg_sd(realtype *dwdp, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w, const realtype *tcl, const realtype *dtcldp);
extern void dwdp_colptrs_icg_sd(SUNMatrixWrapper &colptrs);
extern void dwdp_rowvals_icg_sd(SUNMatrixWrapper &rowvals);
extern void dwdx_icg_sd(realtype *dwdx, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w, const realtype *tcl);
extern void dwdx_colptrs_icg_sd(SUNMatrixWrapper &colptrs);
extern void dwdx_rowvals_icg_sd(SUNMatrixWrapper &rowvals);
extern void dwdw_icg_sd(realtype *dwdw, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w, const realtype *tcl);
extern void dwdw_colptrs_icg_sd(SUNMatrixWrapper &colptrs);
extern void dwdw_rowvals_icg_sd(SUNMatrixWrapper &rowvals);
extern void dxdotdw_icg_sd(realtype *dxdotdw, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w);
extern void dxdotdw_colptrs_icg_sd(SUNMatrixWrapper &colptrs);
extern void dxdotdw_rowvals_icg_sd(SUNMatrixWrapper &rowvals);
extern void dxdotdp_explicit_icg_sd(realtype *dxdotdp_explicit, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w);
extern void dxdotdp_explicit_colptrs_icg_sd(SUNMatrixWrapper &colptrs);
extern void dxdotdp_explicit_rowvals_icg_sd(SUNMatrixWrapper &rowvals);
extern void dxdotdx_explicit_icg_sd(realtype *dxdotdx_explicit, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w);
extern void dxdotdx_explicit_colptrs_icg_sd(SUNMatrixWrapper &colptrs);
extern void dxdotdx_explicit_rowvals_icg_sd(SUNMatrixWrapper &rowvals);
extern void dydx_icg_sd(realtype *dydx, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w, const realtype *dwdx);
extern void dydp_icg_sd(realtype *dydp, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const int ip, const realtype *w, const realtype *tcl, const realtype *dtcldp);




extern void sigmay_icg_sd(realtype *sigmay, const realtype t, const realtype *p, const realtype *k, const realtype *y);




extern void w_icg_sd(realtype *w, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *tcl);
extern void x0_icg_sd(realtype *x0, const realtype t, const realtype *p, const realtype *k);



extern void xdot_icg_sd(realtype *xdot, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w);
extern void y_icg_sd(realtype *y, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w);





extern void x_rdata_icg_sd(realtype *x_rdata, const realtype *x, const realtype *tcl, const realtype *p, const realtype *k);
extern void x_solver_icg_sd(realtype *x_solver, const realtype *x_rdata);
extern void total_cl_icg_sd(realtype *total_cl, const realtype *x_rdata, const realtype *p, const realtype *k);
extern void dx_rdatadx_solver_icg_sd(realtype *dx_rdatadx_solver, const realtype *x, const realtype *tcl, const realtype *p, const realtype *k);
extern void dx_rdatadx_solver_colptrs_icg_sd(SUNMatrixWrapper &colptrs);
extern void dx_rdatadx_solver_rowvals_icg_sd(SUNMatrixWrapper &rowvals);

extern void dx_rdatadtcl_icg_sd(realtype *dx_rdatadtcl, const realtype *x, const realtype *tcl, const realtype *p, const realtype *k);
extern void dx_rdatadtcl_colptrs_icg_sd(SUNMatrixWrapper &colptrs);
extern void dx_rdatadtcl_rowvals_icg_sd(SUNMatrixWrapper &rowvals);

extern void dtotal_cldx_rdata_icg_sd(realtype *dtotal_cldx_rdata, const realtype *x_rdata, const realtype *p, const realtype *k, const realtype *tcl);
extern void dtotal_cldx_rdata_colptrs_icg_sd(SUNMatrixWrapper &colptrs);
extern void dtotal_cldx_rdata_rowvals_icg_sd(SUNMatrixWrapper &rowvals);
/**
 * @brief AMICI-generated model subclass.
 */
class Model_icg_sd : public amici::Model_ODE {
  public:
    /**
    ...
    void fJy(realtype *Jy, const int iy, const realtype *p, const realtype *k, const realtype *y, const realtype *sigmay, const realtype *my) override {
        Jy_icg_sd(Jy, iy, p, k, y, sigmay, my);    
}
    ...
    void fdJydsigma(realtype *dJydsigma, const int iy, const realtype *p, const realtype *k, const realtype *y, const realtype *sigmay, const realtype *my) override {
        dJydsigma_icg_sd(dJydsigma, iy, p, k, y, sigmay, my);    
}
    ...
    void fdJydy(realtype *dJydy, const int iy, const realtype *p, const realtype *k, const realtype *y, const realtype *sigmay, const realtype *my) override {
        dJydy_icg_sd(dJydy, iy, p, k, y, sigmay, my);    
}

    void fdJydy_colptrs(SUNMatrixWrapper &colptrs, int index) override {        dJydy_colptrs_icg_sd(colptrs, index);
    }

    void fdJydy_rowvals(SUNMatrixWrapper &rowvals, int index) override {        dJydy_rowvals_icg_sd(rowvals, index);
    }
    ...
    void fdwdp(realtype *dwdp, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w, const realtype *tcl, const realtype *dtcldp) override {
        dwdp_icg_sd(dwdp, t, x, p, k, h, w, tcl, dtcldp);    
}

    void fdwdp_colptrs(SUNMatrixWrapper &colptrs) override {        dwdp_colptrs_icg_sd(colptrs);
    }

    void fdwdp_rowvals(SUNMatrixWrapper &rowvals) override {        dwdp_rowvals_icg_sd(rowvals);
    }
    ...
    void fdwdx(realtype *dwdx, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w, const realtype *tcl) override {
        dwdx_icg_sd(dwdx, t, x, p, k, h, w, tcl);    
}

    void fdwdx_colptrs(SUNMatrixWrapper &colptrs) override {        dwdx_colptrs_icg_sd(colptrs);
    }

    void fdwdx_rowvals(SUNMatrixWrapper &rowvals) override {        dwdx_rowvals_icg_sd(rowvals);
    }
    ...
    void fdwdw(realtype *dwdw, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w, const realtype *tcl) override {
        dwdw_icg_sd(dwdw, t, x, p, k, h, w, tcl);    
}

    void fdwdw_colptrs(SUNMatrixWrapper &colptrs) override {        dwdw_colptrs_icg_sd(colptrs);
    }

    void fdwdw_rowvals(SUNMatrixWrapper &rowvals) override {        dwdw_rowvals_icg_sd(rowvals);
    }
    ...
    void fdxdotdw(realtype *dxdotdw, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w) override {
        dxdotdw_icg_sd(dxdotdw, t, x, p, k, h, w);    
}

    void fdxdotdw_colptrs(SUNMatrixWrapper &colptrs) override {        dxdotdw_colptrs_icg_sd(colptrs);
    }

    void fdxdotdw_rowvals(SUNMatrixWrapper &rowvals) override {        dxdotdw_rowvals_icg_sd(rowvals);
    }
    ...
    void fdxdotdp_explicit(realtype *dxdotdp_explicit, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w) override {
        dxdotdp_explicit_icg_sd(dxdotdp_explicit, t, x, p, k, h, w);    
}

    void fdxdotdp_explicit_colptrs(SUNMatrixWrapper &colptrs) override {        dxdotdp_explicit_colptrs_icg_sd(colptrs);
    }

    void fdxdotdp_explicit_rowvals(SUNMatrixWrapper &rowvals) override {        dxdotdp_explicit_rowvals_icg_sd(rowvals);
    }
    ...
    void fdxdotdx_explicit(realtype *dxdotdx_explicit, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w) override {
        dxdotdx_explicit_icg_sd(dxdotdx_explicit, t, x, p, k, h, w);    
}

    void fdxdotdx_explicit_colptrs(SUNMatrixWrapper &colptrs) override {        dxdotdx_explicit_colptrs_icg_sd(colptrs);
    }

    void fdxdotdx_explicit_rowvals(SUNMatrixWrapper &rowvals) override {        dxdotdx_explicit_rowvals_icg_sd(rowvals);
    }
    ...
    void fdydx(realtype *dydx, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w, const realtype *dwdx) override {
        dydx_icg_sd(dydx, t, x, p, k, h, w, dwdx);    
}
    ...
    void fdydp(realtype *dydp, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const int ip, const realtype *w, const realtype *tcl, const realtype *dtcldp) override {
        dydp_icg_sd(dydp, t, x, p, k, h, ip, w, tcl, dtcldp);    
}
    ...
    void fdx_rdatadx_solver(realtype *dx_rdatadx_solver, const realtype *x, const realtype *tcl, const realtype *p, const realtype *k) override {
        dx_rdatadx_solver_icg_sd(dx_rdatadx_solver, x, tcl, p, k);    
}

    void fdx_rdatadx_solver_colptrs(SUNMatrixWrapper &colptrs) override {        dx_rdatadx_solver_colptrs_icg_sd(colptrs);
    }

    void fdx_rdatadx_solver_rowvals(SUNMatrixWrapper &rowvals) override {        dx_rdatadx_solver_rowvals_icg_sd(rowvals);
    }
    ...
    void fdx_rdatadtcl(realtype *dx_rdatadtcl, const realtype *x, const realtype *tcl, const realtype *p, const realtype *k) override {
        dx_rdatadtcl_icg_sd(dx_rdatadtcl, x, tcl, p, k);    
}

    void fdx_rdatadtcl_colptrs(SUNMatrixWrapper &colptrs) override {        dx_rdatadtcl_colptrs_icg_sd(colptrs);
    }

    void fdx_rdatadtcl_rowvals(SUNMatrixWrapper &rowvals) override {        dx_rdatadtcl_rowvals_icg_sd(rowvals);
    }
    ...
    void fdtotal_cldx_rdata(realtype *dtotal_cldx_rdata, const realtype *x_rdata, const realtype *p, const realtype *k, const realtype *tcl) override {
        dtotal_cldx_rdata_icg_sd(dtotal_cldx_rdata, x_rdata, p, k, tcl);    
}

    void fdtotal_cldx_rdata_colptrs(SUNMatrixWrapper &colptrs) override {        dtotal_cldx_rdata_colptrs_icg_sd(colptrs);
    }

    void fdtotal_cldx_rdata_rowvals(SUNMatrixWrapper &rowvals) override {        dtotal_cldx_rdata_rowvals_icg_sd(rowvals);
    }
