...
static constexpr std::array<sunindextype, 196> dwdp_rowvals_icg_body_ = {
...
void dwdp_rowvals_icg_body(SUNMatrixWrapper &dwdp){
    dwdp.set_indexvals(gsl::make_span(dwdp_rowvals_icg_body_));
}
} // namespace model_icg_body
} // namespace amici
