...
static constexpr std::array<sunindextype, 73> dwdw_colptrs_icg_body_ = {
...
void dwdw_colptrs_icg_body(SUNMatrixWrapper &dwdw){
    dwdw.set_indexptrs(gsl::make_span(dwdw_colptrs_icg_body_));
}
} // namespace model_icg_body
} // namespace amici
