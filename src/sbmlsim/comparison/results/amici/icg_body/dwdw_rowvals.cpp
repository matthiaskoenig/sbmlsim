...
static constexpr std::array<sunindextype, 56> dwdw_rowvals_icg_body_ = {
...
void dwdw_rowvals_icg_body(SUNMatrixWrapper &dwdw){
    dwdw.set_indexvals(gsl::make_span(dwdw_rowvals_icg_body_));
}
} // namespace model_icg_body
} // namespace amici
