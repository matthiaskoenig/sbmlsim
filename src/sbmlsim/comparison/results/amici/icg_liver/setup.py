...
def get_extension() -> Extension:
    ...
    sources = [os.path.join("swig", "icg_liver.i"), *get_model_sources()]
    ...
    # Build shared object
    ext = Extension(
        'icg_liver._icg_liver',
        sources=sources,
        include_dirs=ext_include_dirs,
        libraries=libraries,
        library_dirs=ext_library_dirs,
        swig_opts=[
            '-c++', '-modern', '-outdir', 'icg_liver',
...
setup(
    ...
    cmdclass=CMDCLASS,
    version='0.1.0',
    description='AMICI-generated module for model icg_liver',
