...
if _stacked:
    tefig = _engine.newStackedFigure(title='plot2d_Simulation1 (Application0plots)', xtitle='time_repeatedTask_0_0 (time_repeatedTask_0_0)')
else:
    tefig = _engine.newFigure(title='plot2d_Simulation1 (Application0plots)', xtitle='time_repeatedTask_0_0 (time_repeatedTask_0_0)')

for k in range(time_repeatedTask_0_0.shape[1]):
    extra_args = {}
    if k == 0:
        extra_args['name'] = 'dataGen_repeatedTask_0_0_s0 (curve_0)'
    tefig.addXYDataset(time_repeatedTask_0_0[:,k], dataGen_repeatedTask_0_0_s0[:,k], color='C0', tag='tag0', **extra_args)
for k in range(time_repeatedTask_0_0.shape[1]):
    extra_args = {}
    if k == 0:
        extra_args['name'] = 'dataGen_repeatedTask_0_0_s1 (curve_1)'
    tefig.addXYDataset(time_repeatedTask_0_0[:,k], dataGen_repeatedTask_0_0_s1[:,k], color='C1', tag='tag1', **extra_args)
fig = tefig.render()
