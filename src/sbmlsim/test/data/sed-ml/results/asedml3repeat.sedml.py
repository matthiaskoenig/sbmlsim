...
if _stacked:
    tefig = _engine.newStackedFigure(title='plot2d_Simulation0 (Application0plots)', xtitle='time_repeatedTask_0_0 (time_repeatedTask_0_0)')
else:
    tefig = _engine.newFigure(title='plot2d_Simulation0 (Application0plots)', xtitle='time_repeatedTask_0_0 (time_repeatedTask_0_0)')
