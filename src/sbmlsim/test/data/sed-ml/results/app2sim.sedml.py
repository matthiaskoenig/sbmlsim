...
if Application0.conservedMoietyAnalysis == True: Application0.conservedMoietyAnalysis = False
...
if Application0_0.conservedMoietyAnalysis == True: Application0_0.conservedMoietyAnalysis = False
...
if _stacked:
    tefig = _engine.newStackedFigure(title='plot2d_Simulation0 (Application0plots)', xtitle='time_task_0_0 (time_task_0_0)')
else:
    tefig = _engine.newFigure(title='plot2d_Simulation0 (Application0plots)', xtitle='time_task_0_0 (time_task_0_0)')

for k in range(time_task_0_0.shape[1]):
    extra_args = {}
    if k == 0:
        extra_args['name'] = 'dataGen_task_0_0_s0 (curve_0)'
    tefig.addXYDataset(time_task_0_0[:,k], dataGen_task_0_0_s0[:,k], color='C0', tag='tag0', **extra_args)
for k in range(time_task_0_0.shape[1]):
    extra_args = {}
    if k == 0:
        extra_args['name'] = 'dataGen_task_0_0_s1 (curve_1)'
    tefig.addXYDataset(time_task_0_0[:,k], dataGen_task_0_0_s1[:,k], color='C1', tag='tag1', **extra_args)
fig = tefig.render()
...
_engine = te.getPlottingEngine()
if _stacked:
    tefig = _engine.newStackedFigure(title='plot2d_Simulation1 (Application0plots)', xtitle='time_task_0_1 (time_task_0_1)')
else:
    tefig = _engine.newFigure(title='plot2d_Simulation1 (Application0plots)', xtitle='time_task_0_1 (time_task_0_1)')

for k in range(time_task_0_1.shape[1]):
    extra_args = {}
    if k == 0:
        extra_args['name'] = 'dataGen_task_0_1_s0 (curve_0)'
    tefig.addXYDataset(time_task_0_1[:,k], dataGen_task_0_1_s0[:,k], color='C0', tag='tag0', **extra_args)
for k in range(time_task_0_1.shape[1]):
    extra_args = {}
    if k == 0:
        extra_args['name'] = 'dataGen_task_0_1_s1 (curve_1)'
    tefig.addXYDataset(time_task_0_1[:,k], dataGen_task_0_1_s1[:,k], color='C1', tag='tag1', **extra_args)
fig = tefig.render()
