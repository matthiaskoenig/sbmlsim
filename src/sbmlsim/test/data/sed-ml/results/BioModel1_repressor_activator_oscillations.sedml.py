...
for __k__range_0_0_common_delta_A, __value__range_0_0_common_delta_A in enumerate(__range__range_0_0_common_delta_A):
    ...
    if repressor_activator_oscillations.conservedMoietyAnalysis == True: repressor_activator_oscillations.conservedMoietyAnalysis = False
    repressor_activator_oscillations['common_delta_A'] = __value__range_0_0_common_delta_A
    repressor_activator_oscillations.timeCourseSelections = ['[PrmR]', '[R]', 'time', '[A]', '[mRNA_R]', '[mRNA_A_]', '[PrmA_bound]', '[C]', '[PrmR_bound]', '[PrmA]']
    repressor_activator_oscillations.reset()
...
__var__mRNA_R = np.concatenate([process_trace(sim['[mRNA_R]']) for sim in repeatedTask_0_0])
...
__var__PrmA_bound = np.concatenate([process_trace(sim['[PrmA_bound]']) for sim in repeatedTask_0_0])
...
__var__PrmR_bound = np.concatenate([process_trace(sim['[PrmR_bound]']) for sim in repeatedTask_0_0])
...
__var__mRNA_A_ = np.concatenate([process_trace(sim['[mRNA_A_]']) for sim in repeatedTask_0_0])
...
if _stacked:
    tefig = _engine.newStackedFigure(title='plot2d_scan_for_delta_A (repressor_activator_oscillationsplots)', xtitle='time_repeatedTask_0_0 (time_repeatedTask_0_0)')
else:
    tefig = _engine.newFigure(title='plot2d_scan_for_delta_A (repressor_activator_oscillationsplots)', xtitle='time_repeatedTask_0_0 (time_repeatedTask_0_0)')

for k in range(time_repeatedTask_0_0.shape[1]):
    extra_args = {}
    if k == 0:
        extra_args['name'] = 'dataGen_repeatedTask_0_0_mRNA_R (curve_0)'
    tefig.addXYDataset(time_repeatedTask_0_0[:,k], dataGen_repeatedTask_0_0_mRNA_R[:,k], color='C0', tag='tag0', **extra_args)
for k in range(time_repeatedTask_0_0.shape[1]):
    extra_args = {}
    if k == 0:
        extra_args['name'] = 'dataGen_repeatedTask_0_0_A (curve_1)'
    tefig.addXYDataset(time_repeatedTask_0_0[:,k], dataGen_repeatedTask_0_0_A[:,k], color='C1', tag='tag1', **extra_args)
for k in range(time_repeatedTask_0_0.shape[1]):
    extra_args = {}
    if k == 0:
        extra_args['name'] = 'dataGen_repeatedTask_0_0_R (curve_2)'
    tefig.addXYDataset(time_repeatedTask_0_0[:,k], dataGen_repeatedTask_0_0_R[:,k], color='C2', tag='tag2', **extra_args)
for k in range(time_repeatedTask_0_0.shape[1]):
    extra_args = {}
    if k == 0:
        extra_args['name'] = 'dataGen_repeatedTask_0_0_PrmA (curve_3)'
    tefig.addXYDataset(time_repeatedTask_0_0[:,k], dataGen_repeatedTask_0_0_PrmA[:,k], color='C3', tag='tag3', **extra_args)
for k in range(time_repeatedTask_0_0.shape[1]):
    extra_args = {}
    if k == 0:
        extra_args['name'] = 'dataGen_repeatedTask_0_0_PrmR (curve_4)'
    tefig.addXYDataset(time_repeatedTask_0_0[:,k], dataGen_repeatedTask_0_0_PrmR[:,k], color='C4', tag='tag4', **extra_args)
for k in range(time_repeatedTask_0_0.shape[1]):
    extra_args = {}
    if k == 0:
        extra_args['name'] = 'dataGen_repeatedTask_0_0_C (curve_5)'
    tefig.addXYDataset(time_repeatedTask_0_0[:,k], dataGen_repeatedTask_0_0_C[:,k], color='C5', tag='tag5', **extra_args)
for k in range(time_repeatedTask_0_0.shape[1]):
    extra_args = {}
    if k == 0:
        extra_args['name'] = 'dataGen_repeatedTask_0_0_PrmA_bound (curve_6)'
    tefig.addXYDataset(time_repeatedTask_0_0[:,k], dataGen_repeatedTask_0_0_PrmA_bound[:,k], color='C6', tag='tag6', **extra_args)
for k in range(time_repeatedTask_0_0.shape[1]):
    extra_args = {}
    if k == 0:
        extra_args['name'] = 'dataGen_repeatedTask_0_0_PrmR_bound (curve_7)'
    tefig.addXYDataset(time_repeatedTask_0_0[:,k], dataGen_repeatedTask_0_0_PrmR_bound[:,k], color='C0', tag='tag7', **extra_args)
for k in range(time_repeatedTask_0_0.shape[1]):
    extra_args = {}
    if k == 0:
        extra_args['name'] = 'dataGen_repeatedTask_0_0_mRNA_A_ (curve_8)'
    tefig.addXYDataset(time_repeatedTask_0_0[:,k], dataGen_repeatedTask_0_0_mRNA_A_[:,k], color='C1', tag='tag8', **extra_args)
fig = tefig.render()
