...
runs without fitting again:
    ...
    python -m examples.hctz.fitting.identifiability_report results/fit/PK/parameters.json
...
# run as a script (`python examples/hctz/fitting/identifiability_report.py`, the
